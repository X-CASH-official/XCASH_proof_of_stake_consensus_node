...
#define BLOCKCHAIN_DATA_NETWORK_VERSION_DATA_SIZE 5
#define BLOCKCHAIN_DATA_TIMESTAMP_DATA_SIZE 11
#define BLOCKCHAIN_DATA_PREVIOUS_BLOCK_HASH_DATA_SIZE 65
#define BLOCKCHAIN_DATA_NONCE_DATA_SIZE 9
#define BLOCKCHAIN_DATA_BLOCK_REWARD_TRANSACTION_VERSION_DATA_SIZE 3
#define BLOCKCHAIN_DATA_UNLOCK_BLOCK_DATA_SIZE 9
#define BLOCKCHAIN_DATA_BLOCK_REWARD_INPUT_DATA_SIZE 3
#define BLOCKCHAIN_DATA_VIN_TYPE_DATA_SIZE 3
#define BLOCKCHAIN_DATA_BLOCK_HEIGHT_DATA_SIZE 9
#define BLOCKCHAIN_DATA_BLOCK_REWARD_OUTPUT_DATA_SIZE 3
#define BLOCKCHAIN_DATA_BLOCK_REWARD_DATA_SIZE 15
#define BLOCKCHAIN_DATA_STEALTH_ADDRESS_OUTPUT_TAG_DATA_SIZE 3
#define BLOCKCHAIN_DATA_STEALTH_ADDRESS_OUTPUT_DATA_SIZE 65
#define BLOCKCHAIN_DATA_EXTRA_BYTES_SIZE_DATA_SIZE 5
#define BLOCKCHAIN_DATA_TRANSACTION_PUBLIC_KEY_TAG_DATA_SIZE 3
#define BLOCKCHAIN_DATA_TRANSACTION_PUBLIC_KEY_DATA_SIZE 65
#define BLOCKCHAIN_DATA_EXTRA_NONCE_TAG_DATA_SIZE 3
#define BLOCKCHAIN_DATA_RESERVE_BYTES_SIZE_DATA_SIZE 5
#define BLOCKCHAIN_DATA_BLOCKCHAIN_RESERVE_BYTES_BLOCK_PRODUCER_DELEGATES_NAME_DATA_SIZE 41
#define BLOCKCHAIN_DATA_BLOCKCHAIN_RESERVE_BYTES_BLOCK_PRODUCER_DELEGATES_NAME_SIZE 21
#define BLOCKCHAIN_DATA_BLOCKCHAIN_RESERVE_BYTES_BLOCK_PRODUCER_PUBLIC_ADDRESS_DATA_SIZE 197
#define BLOCKCHAIN_DATA_BLOCKCHAIN_RESERVE_BYTES_BLOCK_PRODUCER_PUBLIC_ADDRESS_SIZE 99
#define BLOCKCHAIN_DATA_BLOCKCHAIN_RESERVE_BYTES_BLOCK_PRODUCER_NODE_BACKUP_COUNT_DATA_SIZE 2
#define BLOCKCHAIN_DATA_BLOCKCHAIN_RESERVE_BYTES_BLOCK_PRODUCER_BACKUP_NODES_NAMES_DATA_SIZE 249
#define BLOCKCHAIN_DATA_BLOCKCHAIN_RESERVE_BYTES_BLOCK_PRODUCER_BACKUP_NODES_NAMES_SIZE 125
#define BLOCKCHAIN_DATA_BLOCKCHAIN_RESERVE_BYTES_BLOCK_VALIDATION_NODE_SIGNATURE_DATA_SIZE 196
#define BLOCKCHAIN_DATA_RINGCT_VERSION_DATA_SIZE 3
#define BLOCKCHAIN_DATA_TRANSACTION_AMOUNT_DATA 65
